                ...
                <div className="editprofile flex flex-col gap-5 ">
                    <div className="text-text firstname flex-left w-full">
                        ...
                        <input
                            ...
                            className={`text-text text-xl w-90 min-h-10 pl-2 ${
                                editablefields.firstName ? `border-2 border-black rounded-sm` : ``
                            }`}
                            disabled={!editablefields.firstName}
                        />
                        <button
                            onClick={() =>
                                setEditablefields((prev) => ({ ...prev, firstName: !editablefields.firstName }))
                            }
                        >
                    ...
                    <div className="text-text lastname flex-left w-full">
                        ...
                        <input
                            ...
                            name="lastName"
                            className={`text-text text-xl w-90 min-h-10 pl-2 ${
                                editablefields.lastName ? `border-2 border-black rounded-sm` : ``
                            }`}
                            disabled={!editablefields.lastName}
                        />
                        <button
                            onClick={() =>
                                setEditablefields((prev) => ({ ...prev, lastName: !editablefields.lastName }))
                            }
                        >
                            <Edit className="ml-2 text-text cursor-pointer" />
                        </button>
                    ...
                    <div className="text-text name flex-left w-full">
                        ...
                        />
                        <button
                            onClick={() => setEditablefields((prev) => ({ ...prev, email: !editablefields.email }))}
                        >
                            <Edit className="ml-2 text-text cursor-pointer" />
                        </button>
                    </div>
                    <div className="text-text name top-left w-full">
                        ...
                        />
                        <button
                            onClick={() => setEditablefields((prev) => ({ ...prev, about: !editablefields.about }))}
                        >
                            <Edit className="ml-2 text-text cursor-pointer" />
                        </button>
                    </div>
                </div>
                <div className={`btns flex gap-5 ${user === userCopy ? `hidden` : `flex`}`}>
                    <button
