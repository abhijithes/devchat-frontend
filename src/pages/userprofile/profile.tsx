                ...
                <div className="bg-white border border-t-0 border-gray-100 p-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-4 p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
                            <label className="text-lg font-semibold text-gray-700 min-w-[120px]">First Name</label>
                        ...
                        {/* Last Name */}
                        <div className="flex flex-col sm:flex-row sm:items-center gap-4 p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
                            <label className="text-lg font-semibold text-gray-700 min-w-[120px]">Last Name</label>
                            <div className="flex-1 flex items-center gap-3">
                                <input
                                    type="text"
                                    maxLength={30}
                        ...
                        {/* Email */}
                        <div className="flex flex-col sm:flex-row sm:items-center gap-4 p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
                            <label className="text-lg font-semibold text-gray-700 min-w-[120px]">Email</label>
                            <div className="flex-1 flex items-center gap-3">
                                <input
                                    type="email"
                                    value={user.email}
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
                            <label className="text-lg font-semibold text-gray-700 min-w-[120px] sm:mt-2">About</label>
