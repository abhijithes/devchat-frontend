        ...
        <section className="relative bg-white flex flex-col items-center justify-center min-h-screen text-center px-6 overflow-hidden ">
            ...
            >
                ...
                <p className="mt-8 text-sm text-gray-500 leading-relaxed max-w-2xl mx-auto">
                    DevChats AI isn’t just another chatbot — it’s a companion built for developers. From managing tasks
                    and explaining code to helping you debug efficiently, it’s here to make your daily workflow smoother
                    and smarter.
                </p>
            </motion.div>
        </section>
