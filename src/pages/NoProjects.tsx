                ...
                {showIllustration && (
                    <div className="pointer-events-none select-none">
                        ...
                        <svg
                            ...
                            className="mx-auto"
                        >
                            <rect x="6" y="22" width="172" height="96" rx="8" fill="#F8FAFC" stroke="#E6EEF6" />
                            <rect x="22" y="38" width="140" height="16" rx="3" fill="#EAF2FF" />
                            <rect x="22" y="62" width="110" height="12" rx="3" fill="#F1F5F9" />
                            <rect x="22" y="82" width="80" height="12" rx="3" fill="#F1F5F9" />
                            <circle cx="196" cy="36" r="16" fill="#FEF3C7" stroke="#FDE68A" />
                            <path d="M186 22 L206 50" stroke="#FDE68A" strokeWidth="2" strokeLinecap="round" />
                        </svg>
                    </div>
                )}
