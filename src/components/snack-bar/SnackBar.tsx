...
const SnackBar = ({ message, type = "info", user, navigationPath }: Props) => {
  ...
  const baseClasses =
    "w-[90%] md:w-max fixed text-base flex  items-center justify-start gap-2 px-4 py-2 rounded  border border-zinc-300 shadow-2xl z-[9999] snack-show transition-all duration-300";
  ...
  return (
    <div
      className={`${baseClasses} ${typeClasses} ${positionClasses}`}
