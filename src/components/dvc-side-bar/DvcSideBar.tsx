...
const DvcSideBar = ({
  ...
  return (
    <div
      ref={asideViewRef}
      className={`w-full md:min-w-[30vw] md:w-[40vw] h-screen bg-white shadow-2xl py-8 fixed top-0 
        ${active ? "right-0" : "-right-full"} 
        z-[999] ${isDragging ? "" : "transition-all duration-600"} `}
    >
      <div
        ref={resizeRef}
        className="w-[8px] h-full absolute top-0 left-0 border-l-2 border-dotted border-zinc-300 hover:border-zinc-500 cursor-e-resize  "
      ></div>
