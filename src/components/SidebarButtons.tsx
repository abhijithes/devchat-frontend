            ...
            {userProjects.map((project, index) => (
                <div key={project._id} className="relative group">
                    ...
                    <div
                        ...
                        className="hidden absolute left-full top-0 w-48 sm:w-56 md:w-64 lg:w-72 h-max flex-col gap-3 bg-white border border-zinc-200 rounded-lg z-50 p-4 shadow-xl group-hover:flex"
                    >
