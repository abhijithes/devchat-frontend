...
export const endpoints = {
    ...
    // New Task routes
    createTask: (projectId) => `${current_url}/tickets/projects/${projectId}/tasks`,
    ...
    setTaskProgressStatus: (taskId) => `${current_url}/tickets/task/${taskId}/progressPercentage`,
    ...
    editComment: (taskId, commentId) => `${current_url}/tickets/task/${taskId}/comments/${commentId}`,
    deleteComment: (taskId, commentId) => `${current_url}/tickets/task/${taskId}/comments/${commentId}`,
